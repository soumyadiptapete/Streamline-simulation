function singlecell_streamline_tracer( alpha0_d,beta0_d,m_d,n_d,qx_d,qy_d )
%UNTITLEDy of this function goes here
%   Detailed explanation goes here

global  nx ny i1 j1 dx dy stx sty tofs actofs phi dv;
...
while(m_d<=ny && m_d>=1 && n_d<=nx && n_d>=1)
        ...
        if abs(dq1)<=0.00001 && abs(dq2)>0.00001
           t11= -alpha0/q11;
           t12=(1-alpha0)/q11;
           i1=i1+1;
           ...
           stx(j1,i1)= stx(j1,i1-1)-(alpha0-alpha)*dx(m_d,n_d);
           sty(j1,i1)=sty(j1,i1-1)-(beta0-beta)*dy(m_d,n_d);
           ...
           singlecell_streamline_tracer(alpha0,beta0,m_d2,n_d2,qx_d1,qy_d1);
           break;
           
        elseif(abs(dq2)<=0.00001 && abs(dq1)>0.00001)
             t21= -beta0/q21;
           t22=(1-beta0)/q21;
           i1=i1+1;
        ...
        elseif(abs(dq1)<=0.00001 && abs(dq2)<=0.00001)
